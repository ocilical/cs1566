 ...
 */
function vec_check(v: vec4): void {
    if (v.length < 4) {
 ...
 */
function mat_check(m: mat4): void {
 ...
 * print a vector
 */
function vec_print(v: vec4): void {
 ...
 */
function vec_scale(s: number, v: vec4): vec4 {
    return [
        s * v[0],
        s * v[1],
        s * v[2],
 ...
 */
function vec_add(v1: vec4, v2: vec4): vec4 {
    return [
        v1[0] + v2[0],
        v1[1] + v2[1],
        v1[2] + v2[2],
 ...
 */
function vec_sub(v1: vec4, v2: vec4): vec4 {
    return [
        v1[0] - v2[0],
        v1[1] - v2[1],
        v1[2] - v2[2],
 ...
 */
function vec_length(v: vec4): number {
    return Math.sqrt(
        v[0] * v[0] +
        v[1] * v[1] +
        v[2] * v[2] +
 ...
 */
function vec_dot(v1: vec4, v2: vec4): number {
    return (
        (v1[0] * v2[0]) +
        (v1[1] * v2[1]) +
        (v1[2] * v2[2]) +
 ...
 */
function vec_cross(v1: vec4, v2: vec4): vec4 {
    return [
        (v1[1] * v2[2]) - (v1[2] * v2[1]),
        (v1[2] * v2[0]) - (v1[0] * v2[2]),
        (v1[0] * v2[1]) - (v1[1] * v2[0]),
 ...
 * print a matrix
 */
function mat_print(m: mat4): void {
 ...
 */
function mat_scale(s: number, m: mat4): mat4 {
    return [
        vec_scale(s, m[0]),
        vec_scale(s, m[1]),
        vec_scale(s, m[2]),
 ...
 */
function mat_add(m1: mat4, m2: mat4): mat4 {
    return [
        vec_add(m1[0], m2[0]),
        vec_add(m1[1], m2[1]),
        vec_add(m1[2], m2[2]),
 ...
 */
function mat_vec_mul(m: mat4, v: vec4): vec4 {
 ...
 */
function mat_mul(m1: mat4, m2: mat4): mat4 {
    return [
        mat_vec_mul(m1, m2[0]),
        mat_vec_mul(m1, m2[1]),
        mat_vec_mul(m1, m2[2]),
 ...
 */
function mat_trans(m: mat4): mat4 {
    return [
